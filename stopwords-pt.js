// stopwords-pt.js
// Lista de stop words em Português [2, 3, 4]
// Esta é uma lista compilada e pode ser expandida ou ajustada conforme necessário.
const portugueseStopWords = [
    ...
    'aquela', 'aqueles', 'aquelas', 'isto', 'aquilo', 'estou', 'estamos', 'estiveram',
    ...
    'estiverem', 'hei', 'havemos', 'hão', 'houve', 'houvemos', 'houveram', 'houvera',
    ...
    'houveria', 'houveríamos', 'houveriam', 'sou', 'somos', 'são', 'éramos', 'eram',
    'fui', 'foi', 'fomos', 'foram', 'fora', 'fôramos', 'sejamos', 'sejam', 'fossemos',
    'fossem', 'for', 'formos', 'forem', 'serei', 'seremos', 'serão', 'seria', 'seríamos',
    'seriam', 'temos', 'tínhamos', 'tinham', 'tive', 'teve', 'tivemos', 'tiveram',
    'tivera', 'tivéramos', 'tenha', 'tenhamos', 'tenham', 'tivesse', 'tivéssemos',
    'tivessem', 'tivermos', 'tiverem', 'terei', 'terá', 'teremos', 'terão', 'teria',
    'teríamos', 'teriam',
    // Adicionais comuns
    'sobre', 'seu', 'seus', 'sua', 'suas', 'tal', 'tais', 'tampouco', 'teu', 'teus', 'ti',
    'tido', 'toda', 'todas', 'todo', 'todos', 'tu', 'tua', 'tuas', 'onde', 'quais', 'quão',
    'quanta', 'quantas', 'quanto', 'quantos'
];